...
Verglichen werden das Xtext-Framework zur Erstellung \emph{externer DSLs} und
die Scala-Programmiersprache zur Erstellung \emph{interner DSLs}.

Die so entstehenden Sprache ist eine interne Scala-DSL, mit einer
...
\include{chapters/2-problembeschreibung}
%\include{chapters/3-loesungsalternativen}
\include{chapters/4-vergleich}
\include{chapters/5-architektur}
\include{chapters/6-zusammenfassung}
