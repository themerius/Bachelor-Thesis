...
Bei der DSL wurden auch nur die wichtigsten Funktionen
implementiert, um zu zeigen, dass die Umsetzung in einem überschaubaren
Rahmen möglich ist. Wobei die größte Schwierigkeit eine Lösung für den
Vorwärtsverweis zu finden war.
