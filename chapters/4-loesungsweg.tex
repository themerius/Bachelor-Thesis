...
die Fähigkeiten bzw. die Möglichkeiten von Xtext und
Scala (als interne DSL) gegenübergestellt und bewertet werden.
Dabei wird bei jeder Fähigkeit bewertet, ob Xtext oder Scala die besseren
Argumente liefert.
Zu beachten ist jedoch, dass die Bewertungen auf das hier vorliegende Projekt
angepasst sind und sich somit nicht 1:1 auf beliebige Projekte anwenden lassen.
Die Bewertungen bzw. Gewichtungen müssen also für jedes Projekt und dessen
spezifischen Anforderungen individuell angepasst werden.
...
Und wird als eigentliche Implementierungsbasis verwendet, siehe dazu
Kapitel \ref{sec-scalaDSL}.
