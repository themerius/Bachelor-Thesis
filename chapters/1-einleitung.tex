...
\paragraph{Was diese Thesis klären will ist}
...
da Versionskontrolltools wie \emph{git} eingesetzt werden können -- also
...
\paragraph{Szenario 0:} Integration von verschiedenen „Markup-Formaten“.
...
umwandeln zu lassen, also Kapitel, Texte, Bilder etc. extrahieren und so in
...
Dokumenten-Darstellung. So dass man beispielsweise komplexte Tabellen aus
Listen zusammenstellen kann und diese Listen können dann Resultate
...
rechnen, sie weiterverarbeiten oder anreichern.
...
einen Zugriff über Excel zu machen, dass ich als Dokumenten-Ersteller
über meine gewohnte Excel-Abläufe meine Daten zusammenstelle und die xls-Datei
über den Programmcode einbinde. Excel könnte so auch bei Bedarf geöffnet
werden, neue Daten holen und eine aktualiserte xls-Datei ablegen. Die
Kommunikation könnte dann als VB-Script ablaufen. → Einbettung
