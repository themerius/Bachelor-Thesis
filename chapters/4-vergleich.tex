...
\begin{longtable}{|p{0.5cm}|p{0.8cm}|p{4.3cm}|p{6.3cm}|p{6.3cm}|}
  ...
  & {\small Xtext generiert u.a. automatisch ein speziell angepasstes Eclipse Plugin.}
  & {\small Alles wird mitgeliefert, wie z.B. Compiler, Built-Tools, REPL.
    Breite Unterstützung von vielen Editoren, aber keine speziellen Tools.}
  \\\hline

  8
  & \ref{sec-scalierEinbett}
  & Einbettbarkeit in beliebige Umgebungen
  & {\small Relativ starke Eclipse-Bindung, aber mit individuell angepasstem Eclipse-Plugin,
  ...
  & {\small Die DSL selbst kann direkt ein lauffähiges Programm sein. Andere Ziele,
    ...
    Verfahren hierzu muss selbst entwickelt werden.}
  \\\hline
  ...
  & {\small Wenn Scala-Kenntnisse vorhanden, ist es mehr oder weniger die Entwicklung
    einer Bibliothek.
    Wie der Generator gebaut wird, muss allerdings überlegt werden.}
  \\\hline
