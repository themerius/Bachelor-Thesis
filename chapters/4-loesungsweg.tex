...
Xtext hat zwei unterschiedliche Möglichkeiten ein Generat zu erstellen,
zum einen den \emph{Code Generator mit Xtend}, zum anderen den
\emph{ModelInferrer mit Xbase}.
...
Scala hingegen hat die Qual der Wahl was das Templating angeht. Scala selbst
bietet in der Standard-Bibliothek schon eine Reihe an Möglichkeiten an,
...
Der Vorteil hier ist die sehr hohe Freiheit und Flexibilität, aber es ist
viel Handarbeit nötig -- daher führt Xtext hier \emph{leicht}.
